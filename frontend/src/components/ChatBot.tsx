...
export function ChatBot({
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      role: "assistant",
      content: `Hi! I'm here to help you with your code. I can see you're working on task ${
        currentTask + 1
      } in ${language}. Ask me anything about your code!`,
      timestamp: new Date(),
    },
  ]);
  ...
  const handleSend = async () => {
    ...
    const todos =
      scaffold?.task_todos?.[`task_${currentTask}`] || scaffold?.todos || [];
  ...
  const generateFallbackResponse = (
    ...
    if (
      ...
      let suggestions = `Looking at your code for task ${
        task + 1
    ...
    if (
      ...
      if (lang === "python") {
        return (
          `Here's Python syntax help for task ${task + 1}:\n\n` +
        ...
        return (
          `Here's JavaScript syntax help for task ${task + 1}:\n\n` +
    ...
    if (
      ...
      return (
        ...
        `${
          hasFunctions
            ? "I can see you have functions defined - make sure they return the correct values."
            : "Consider what functions or logic you need to implement."
        }`
      );
    }
    ...
    if (
      query.includes("test") ||
      query.includes("run") ||
      query.includes("execute")
    ) {
      return (
        `To test your code, click the "Run Tests" button below the editor. ` +
    ...
    if (
      ...
      return (
        `I'm here to help! I can see your code for task ${
          task + 1
        } in ${lang}. ` +
        `I can help you with:\n\n` +
        `• Debugging errors\n` +
    ...
    return (
      ...
      `Based on your code for task ${
        task + 1
      } in ${lang}, I can help you with syntax, logic, debugging, or best practices. ` +
      `${
        hasFunctions
          ? "I can see you have functions in your code - would you like help with any of them?"
          : "What specific part would you like help with?"
      }`
    );
  };
          ...
          <div className="flex gap-3 justify-start">
            ...
            <div className="bg-gray-50 dark:bg-muted border border-black/5 dark:border-border rounded-lg p-3">
              <div className="flex gap-1">
                <div
                  className="h-2 w-2 bg-gray-400 dark:bg-muted-foreground rounded-full animate-bounce"
